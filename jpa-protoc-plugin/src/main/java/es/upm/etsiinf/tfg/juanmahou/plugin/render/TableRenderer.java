...
import es.upm.etsiinf.tfg.juanmahou.plugin.types.PrimitiveType;
...
public class TableRenderer {
    public static String render(Table table) {
        ...
        rest_fields.addFirst(new Field(table, "id", new PrimitiveType("Key"), new Annotation(TypeRegistry.EMBEDDED_ID_ANNOTATION)));
