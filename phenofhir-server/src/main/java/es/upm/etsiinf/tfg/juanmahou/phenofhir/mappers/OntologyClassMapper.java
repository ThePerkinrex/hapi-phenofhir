...
@Component
@MapperAlias("OntologyClass")
public class OntologyClassMapper implements Mapper<OntologyClass, Coding> {
    ...
    public OntologyClassMapper(Config config, CurieMappingRepository repository) {
        this.config = config;
    ...
    public OntologyClass toPheno(Coding coding) throws Exception {
        ...
        oc.id = new OntologyClass.Key(mapping.getCurie() + ":" + coding.getCode());
        oc.label = coding.getDisplay();
        return oc;
    }
}
